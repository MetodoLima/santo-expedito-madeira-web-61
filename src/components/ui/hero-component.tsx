...
export function Component() {
  ...
  return (
    <div 
      className="min-h-screen bg-cover bg-center bg-no-repeat text-slate-800 overflow-hidden" 
      style={{
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div 
          className="absolute top-20 right-20 w-72 h-72 bg-gradient-to-r from-green-200/30 to-emerald-200/30 rounded-full blur-3xl" 
          animate={{
            scale: [1, 1.2, 1],
            opacity: [0.3, 0.5, 0.3]
          }} 
        ...
        />
        <motion.div 
          className="absolute bottom-20 left-20 w-96 h-96 bg-gradient-to-r from-red-200/20 to-rose-200/20 rounded-full blur-3xl" 
          animate={{
            scale: [1.2, 1, 1.2],
            opacity: [0.2, 0.4, 0.2]
          }} 
        ...
        />
        <motion.div 
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-gradient-to-r from-green-200/20 to-red-200/20 rounded-full blur-3xl" 
          animate={{
            rotate: [0, 360],
            scale: [1, 1.1, 1]
          }} 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:grid lg:grid-cols-12 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-6 text-center lg:text-left mb-8 lg:mb-0">
              ...
              >
                <motion.div 
                  className="inline-flex items-center space-x-2 mb-6 lg:mb-8 bg-gradient-to-r from-green-50 to-red-50 border border-green-200/50 px-3 py-2 rounded-full" 
                  initial={{
                    opacity: 0,
                    scale: 0.8
                  }} 
                ...
                <motion.p 
                  className="font-inter text-base sm:text-lg lg:text-xl text-slate-500 font-light mb-8 lg:mb-10 max-w-2xl mx-auto lg:mx-0 leading-relaxed px-4 sm:px-0" 
                  initial={{
                    opacity: 0,
                    y: 30
                  }} 
                ...
                <motion.div 
                  className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-12 lg:mb-16 justify-center lg:justify-start px-4 sm:px-0" 
                  initial={{
                    opacity: 0,
                    y: 30
                  }} 
                ...
                >
                  <Button 
                    ...
                    className="bg-[#25D366] hover:bg-[#1DA851] text-white px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base font-bold rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl" 
                    size="default"
                  >
                  ...
                  <Button 
                    ...
                    variant="outline" 
                    className="bg-white border-2 border-red-600 text-red-600 hover:bg-red-600 hover:text-white px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base font-semibold rounded-xl transition-all duration-300 shadow-md hover:shadow-lg" 
                    size="default"
                  >
            ...
            <div className="lg:col-span-6 mt-8 lg:mt-0">
              <motion.div 
                className="relative max-w-sm sm:max-w-lg mx-auto lg:max-w-none" 
                initial={{
                  opacity: 0,
                  y: 50
                }} 
              ...
              >
                ...
                {/* Floating Elements */}
                <motion.div 
                  className="absolute -top-3 -right-3 sm:-top-4 sm:-right-4 bg-gradient-to-r from-green-600 to-emerald-700 p-2 sm:p-3 rounded-xl sm:rounded-2xl shadow-xl" 
                  animate={{
                    y: [0, -8, 0],
                    rotate: [0, 3, 0]
                  }} 
                ...
                <motion.div 
                  className="absolute -bottom-3 -left-3 sm:-bottom-4 sm:-left-4 bg-gradient-to-r from-red-600 to-rose-600 p-2 sm:p-3 rounded-xl sm:rounded-2xl shadow-xl" 
                  animate={{
                    y: [0, 8, 0],
                    rotate: [0, -3, 0]
                  }} 
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
              {features.map((feature, index) => (
                <motion.div 
                  key={feature.title} 
                  className="flex flex-col sm:flex-row items-center sm:items-center space-y-3 sm:space-y-0 sm:space-x-3 p-3 sm:p-4 lg:p-5 rounded-xl sm:rounded-2xl bg-white/70 backdrop-blur-sm border border-slate-200/50 shadow-lg hover:shadow-2xl transition-all duration-300" 
                  initial={{
                    opacity: 0,
                    y: 20,
                    scale: 0.95
